    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color(0xFFF7924A),
          primary: const Color(0xFFF7924A),
        ),
        useMaterial3: true,
      ),
...
class _AnimatedSplashScreenState
    extends State<AnimatedSplashScreen>
  ...
  void initState() {
    ...
    _textOrangeIn = Tween<double>(
      begin: 0,
      end: 1,
    ).animate(
      CurvedAnimation(
        parent: _ctrl,
        curve: const Interval(0.00, 0.18,
    ...
    _dotY = Tween<double>(
      ...
      CurvedAnimation(
        parent: _ctrl,
        curve: const Interval(0.22, 0.40,
            curve: Curves.easeIn),
      ),
    );
    ...
    _textOrangeOut = Tween<double>(
      begin: 1,
      end: 0,
    ).animate(
      CurvedAnimation(
        parent: _ctrl,
        curve: const Interval(0.38, 0.44,
            curve: Curves.easeOut),
      ),
    );

    _textWhiteIn = Tween<double>(
      begin: 0,
      end: 1,
    ).animate(
      CurvedAnimation(
        parent: _ctrl,
        curve: const Interval(0.42, 0.50,
            curve: Curves.easeIn),
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        ...
        final double whiteOp =
            t >= 0.42 ? _textWhiteIn.value : 0.0;

        final bool isFull = t >= 0.84;

        return Scaffold(
          backgroundColor:
              isFull ? _orange : Colors.white,
